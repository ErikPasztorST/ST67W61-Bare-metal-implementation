...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	while (1)
	{
		...
		if (CHECK_EVENT_BIT(EVT_BLE_CONNECT))
		{
			CLEAR_EVENT_BIT(EVT_BLE_CONNECT);
		}
...
#if (COLOR_LEVEL_LIMIT > 0)
		if (raw_level > COLOR_LEVEL_LIMIT) raw_level = COLOR_LEVEL_LIMIT;
#endif
